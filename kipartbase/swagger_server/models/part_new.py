...
class PartNew(Model):
    ...
    """
    def __init__(self, name=None, description=None, comment=None, octopart=None, updated=None, category=None, childs=None, footprint=None, parameters=None, distributors=None):
        """
