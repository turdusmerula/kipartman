...
class PartNew(BaseModel):
    ...
    """
    def __init__(self, name=None, description=None, comment=None, octopart=None, updated=None, category=None, childs=None, footprint=None, model=None, parameters=None, distributors=None, manufacturers=None, storages=None, attachements=None):
        """
