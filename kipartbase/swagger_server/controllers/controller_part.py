...
from swagger_server.controllers.controller_part_parameter import find_part_parameter_name, find_part_parameters, deserialize_PartParameter
...
def serialize_PartData(fpart, part=None, with_parameters=True):
    ...
    if fpart.value_parameter:
        part.value_parameter = fpart.value_parameter
