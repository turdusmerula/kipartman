...
###########################################################################
## Class PanelFootprintLibraries
###########################################################################

class PanelFootprintLibraries ( wx.Panel ):
	...
	def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( 1086,756 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
		...
		self.menu_libraries_add_footprint.SetBitmap( wx.Bitmap( u"resources/add.png", wx.BITMAP_TYPE_ANY ) )
		self.menu_libraries.Append( self.menu_libraries_add_footprint )

		self.Bind( wx.EVT_RIGHT_DOWN, self.PanelFootprintLibrariesOnContextMenu )
	...
	def PanelFootprintLibrariesOnContextMenu( self, event ):
