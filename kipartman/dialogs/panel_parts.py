...
class PanelParts ( wx.Panel ):
	...
	def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( 848,489 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
		...
		self.splitter = wx.SplitterWindow( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.SP_3D|wx.SP_3DBORDER|wx.SP_LIVE_UPDATE )
		self.splitter.Bind( wx.EVT_IDLE, self.splitterOnIdle )
		self.splitter.SetMinimumPaneSize( 100 )

		self.panel_left = wx.Panel( self.splitter, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
		self.panel_right = wx.Panel( self.splitter, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
		self.splitter.SplitVertically( self.panel_left, self.panel_right, 449 )
	...
	def splitterOnIdle( self, event ):
		self.splitter.SetSashPosition( 449 )
