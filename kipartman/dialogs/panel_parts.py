...
class PanelParts ( wx.Panel ):
	...
	def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( 1361,758 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
		...
		self.button_refresh_categories = wx.BitmapButton( self.panel_category, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW|0|wx.BORDER_NONE )
		...
		self.button_refresh_parts = wx.BitmapButton( self.panel_parts, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW|0|wx.BORDER_NONE )
