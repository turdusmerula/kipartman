...
class PanelPartCategories ( wx.Panel ):
	...
	def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( 616,396 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
		...
		self.button_refresh_categories = wx.BitmapButton( self, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW|wx.BORDER_NONE|wx.BORDER_NONE )
		...
		self.tree_categories = wx.dataview.DataViewCtrl( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer1.Add( self.tree_categories, 1, wx.ALL|wx.EXPAND, 5 )
