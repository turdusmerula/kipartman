...
###########################################################################
## Class PanelEditFootprintProto
###########################################################################

class PanelEditFootprintProto ( wx.Panel ):
	...
	def __init__( self, parent ):
		...
		self.Bind( wx.EVT_RIGHT_DOWN, self.PanelEditFootprintProtoOnContextMenu ) 
	...
	def PanelEditFootprintProtoOnContextMenu( self, event ):
