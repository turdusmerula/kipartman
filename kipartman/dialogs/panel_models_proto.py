...
###########################################################################
## Class PanelModelsProto
###########################################################################

class PanelModelsProto ( wx.Panel ):
	...
	def __init__( self, parent ):
		...
		self.Bind( wx.EVT_RIGHT_DOWN, self.PanelModelsProtoOnContextMenu ) 
	...
	def PanelModelsProtoOnContextMenu( self, event ):
