...
class DialogEditStorage ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		# Connect Events
		self.text_name.Bind( wx.EVT_TEXT, self.onValueChanged )
		self.text_description.Bind( wx.EVT_TEXT, self.onValueChanged )
		self.text_comment.Bind( wx.EVT_TEXT, self.onValueChanged )
