...
class PanelPartEcad ( wx.Panel ):
	...
	def __init__( self, parent ):
		...
		self.tree_ecaddata = wx.dataview.DataViewCtrl( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer12.Add( self.tree_ecaddata, 1, wx.ALL|wx.EXPAND, 5 )
