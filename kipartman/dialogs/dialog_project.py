...
class DialogProject ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.button_refresh_project = wx.BitmapButton( self.panel_project, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW|0 )

		self.button_refresh_project.SetBitmap( wx.Bitmap( u"resources/refresh.png", wx.BITMAP_TYPE_ANY ) )
		...
		# Connect Events
		self.Bind( wx.EVT_CLOSE, self.onDialogProjectClose )
