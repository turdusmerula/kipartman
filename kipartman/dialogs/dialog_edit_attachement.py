...
class DialogEditAttachement ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.button_open_file = wx.Button( self, wx.ID_ANY, u"<None>", wx.DefaultPosition, wx.DefaultSize, wx.BU_LEFT|wx.BORDER_NONE )
		bSizer17.Add( self.button_open_file, 1, wx.ALL|wx.EXPAND, 5 )

		self.button_add_file = wx.BitmapButton( self, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW|0 )

		self.button_add_file.SetBitmap( wx.Bitmap( u"resources/browse-16x16.png", wx.BITMAP_TYPE_ANY ) )
