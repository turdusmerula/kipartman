...
class DialogConfiguration ( wx.Dialog ):
	...
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = wx.EmptyString, pos = wx.DefaultPosition, size = wx.Size( 505,653 ), style = wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER )
		...
		bSizer10.Add( sbSizer111, 1, wx.EXPAND|wx.ALL, 5 )
		...
		bSizer10.Add( sbSizer11, 1, wx.EXPAND|wx.ALL, 5 )
		...
		bSizer10.Add( sbSizer21, 1, wx.EXPAND|wx.ALL, 5 )
		...
		bSizer10.Add( sbSizer1, 1, wx.EXPAND|wx.ALL, 5 )
		...
		bSizer10.Add( sbSizer2, 1, wx.EXPAND|wx.ALL, 5 )
		...
		bSizer10.Add( m_sdbSizer1, 1, wx.EXPAND|wx.TOP|wx.BOTTOM, 5 )
