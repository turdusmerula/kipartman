...
class DialogEditPartManufacturer ( wx.Dialog ):
	...
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = wx.EmptyString, pos = wx.DefaultPosition, size = wx.Size( 388,165 ), style = wx.DEFAULT_DIALOG_STYLE )
		...
		bSizer1.Add( button_part_edit, 0, wx.EXPAND|wx.TOP|wx.BOTTOM, 5 )
