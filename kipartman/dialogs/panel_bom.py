...
class PanelBom ( wx.Panel ):
	...
	def __init__( self, parent ):
		...
		self.tool_open_brd = self.m_toolBar1.AddLabelTool( wx.ID_ANY, u"tool", wx.Bitmap( u"resources/open-32x32.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None ) 
		...
		self.tool_open_bom1 = self.m_toolBar11.AddLabelTool( wx.ID_ANY, u"tool", wx.Bitmap( u"resources/open-32x32.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None ) 
		
		self.tool_save_bom1 = self.m_toolBar11.AddLabelTool( wx.ID_ANY, u"tool", wx.Bitmap( u"resources/save-32x32.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None ) 
		
		self.tool_refresh_bom1 = self.m_toolBar11.AddLabelTool( wx.ID_ANY, u"tool", wx.Bitmap( u"resources/refresh-32x32.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None ) 
		...
		self.Bind( wx.EVT_TOOL, self.onToolRefreshBom, id = self.tool_refresh_bom1.GetId() )
	...
	def onToolRefreshBom( self, event ):
		event.Skip()
