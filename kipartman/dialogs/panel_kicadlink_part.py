...
class PanelKicadLinkPart ( wx.Panel ):
	...
	def __init__( self, parent ):
		...
		self.panel_kicadlink_part_basic.SetBackgroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_WINDOWFRAME ) )
		...
		self.button_kicad_part_search = wx.Button( self.panel_kicadlink_part_basic, wx.ID_ANY, u"Search", wx.DefaultPosition, wx.DefaultSize, 0 )
