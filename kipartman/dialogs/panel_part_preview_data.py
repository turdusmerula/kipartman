...
class PanelPartPreviewData ( wx.Panel ):
	...
	def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( 759,345 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
		...
		self.m_staticText1 = wx.StaticText( self, wx.ID_ANY, u"Symbol", wx.DefaultPosition, wx.DefaultSize, wx.ST_ELLIPSIZE_MIDDLE|wx.ALIGN_CENTER_HORIZONTAL )
		...
		self.m_staticText11 = wx.StaticText( self, wx.ID_ANY, u"Footprint", wx.DefaultPosition, wx.DefaultSize, wx.ST_ELLIPSIZE_MIDDLE|wx.ALIGN_CENTER_HORIZONTAL )
