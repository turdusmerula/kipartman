...
class KicadGUIEventProcessor(threading.Thread):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #self._thread = ThreadKipartman(target=self.EventProcessor, args=(kcW32eventQueue,))
        print('KicadGUIEventProcessor.__init__')
        pass
    ...
    def EventProcessor(self, multiprocessQueue):
        ...
        '''
        log('EventProcessor: about to start receiving events, THREAD INSTANCE:{}: STATUS:{}'.format(self, self.debugstatus))
