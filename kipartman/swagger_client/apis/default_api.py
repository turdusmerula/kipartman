...
class DefaultApi(object):
    ...
    def add_symbol(self, symbol, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_symbol(symbol, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param SymbolNew symbol: Symbol to add (required)
        :return: Symbol
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.add_symbol_with_http_info(symbol, **kwargs)
        else:
            (data) = self.add_symbol_with_http_info(symbol, **kwargs)
            return data

    def add_symbol_with_http_info(self, symbol, **kwargs):
        """
        Creates a new symbol
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_symbol_with_http_info(symbol, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_symbol" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'symbol' is set
        if ('symbol' not in params) or (params['symbol'] is None):
            raise ValueError("Missing the required parameter `symbol` when calling `add_symbol`")
        ...
        return self.api_client.call_api('/symbols', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def add_symbols_category(self, category, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_symbols_category(category, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param SymbolCategoryNew category: Category to add (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.add_symbols_category_with_http_info(category, **kwargs)
        else:
            (data) = self.add_symbols_category_with_http_info(category, **kwargs)
            return data

    def add_symbols_category_with_http_info(self, category, **kwargs):
        """
        Creates a new symbol category
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_symbols_category_with_http_info(category, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_symbols_category" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'category' is set
        if ('category' not in params) or (params['category'] is None):
            raise ValueError("Missing the required parameter `category` when calling `add_symbols_category`")
        ...
        return self.api_client.call_api('/symbols/categories', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_symbol(self, symbol_id, **kwargs):
        """
        Delete symbol
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_symbol(symbol_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int symbol_id: Footprint id (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.delete_symbol_with_http_info(symbol_id, **kwargs)
        else:
            (data) = self.delete_symbol_with_http_info(symbol_id, **kwargs)
            return data

    def delete_symbol_with_http_info(self, symbol_id, **kwargs):
        """
        Delete symbol
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_symbol_with_http_info(symbol_id, callback=callback_function)
        ...
        if ('symbol_id' not in params) or (params['symbol_id'] is None):
            raise ValueError("Missing the required parameter `symbol_id` when calling `delete_symbol`")
        ...
        if 'symbol_id' in params:
            path_params['symbol_id'] = params['symbol_id']
        ...
        return self.api_client.call_api('/symbol/{symbol_id}', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_symbols_category(self, category_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_symbols_category(category_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.delete_symbols_category_with_http_info(category_id, **kwargs)
        else:
            (data) = self.delete_symbols_category_with_http_info(category_id, **kwargs)
            return data

    def delete_symbols_category_with_http_info(self, category_id, **kwargs):
        """
        Delete symbol category
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_symbols_category_with_http_info(category_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_symbols_category" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'category_id' is set
        if ('category_id' not in params) or (params['category_id'] is None):
            raise ValueError("Missing the required parameter `category_id` when calling `delete_symbols_category`")
        ...
        return self.api_client.call_api('/symbols/category/{category_id}', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def find_symbol(self, symbol_id, **kwargs):
        """
        Return a symbol
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.find_symbol(symbol_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.find_symbol_with_http_info(symbol_id, **kwargs)
        else:
            (data) = self.find_symbol_with_http_info(symbol_id, **kwargs)
            return data

    def find_symbol_with_http_info(self, symbol_id, **kwargs):
        """
        Return a symbol
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.find_symbol_with_http_info(symbol_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method find_symbol" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'symbol_id' is set
        if ('symbol_id' not in params) or (params['symbol_id'] is None):
            raise ValueError("Missing the required parameter `symbol_id` when calling `find_symbol`")
        ...
        return self.api_client.call_api('/symbol/{symbol_id}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def find_symbols(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.find_symbols(callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int category: Filter by category
        :param str search: Search for symbol matching pattern
        :return: list[Symbol]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.find_symbols_with_http_info(**kwargs)
        else:
            (data) = self.find_symbols_with_http_info(**kwargs)
            return data

    def find_symbols_with_http_info(self, **kwargs):
        """
        Return all symbols
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.find_symbols_with_http_info(callback=callback_function)
        ...
        return self.api_client.call_api('/symbols', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def find_symbols_categories(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.find_symbols_categories(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.find_symbols_categories_with_http_info(**kwargs)
        else:
            (data) = self.find_symbols_categories_with_http_info(**kwargs)
            return data

    def find_symbols_categories_with_http_info(self, **kwargs):
        """
        Return all categories for symbols
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.find_symbols_categories_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method find_symbols_categories" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/symbols/categories', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='list[SymbolCategory]',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def find_symbols_category(self, category_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.find_symbols_category(category_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.find_symbols_category_with_http_info(category_id, **kwargs)
        else:
            (data) = self.find_symbols_category_with_http_info(category_id, **kwargs)
            return data

    def find_symbols_category_with_http_info(self, category_id, **kwargs):
        """
        Return a symbol category
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.find_symbols_category_with_http_info(category_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method find_symbols_category" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'category_id' is set
        if ('category_id' not in params) or (params['category_id'] is None):
            raise ValueError("Missing the required parameter `category_id` when calling `find_symbols_category`")
        ...
        return self.api_client.call_api('/symbols/category/{category_id}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_symbol(self, symbol_id, symbol, **kwargs):
        """
        Update symbol
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_symbol(symbol_id, symbol, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int symbol_id: Footprint id (required)
        :param SymbolNew symbol: Symbol to update (required)
        :return: Symbol
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_symbol_with_http_info(symbol_id, symbol, **kwargs)
        else:
            (data) = self.update_symbol_with_http_info(symbol_id, symbol, **kwargs)
            return data

    def update_symbol_with_http_info(self, symbol_id, symbol, **kwargs):
        """
        Update symbol
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_symbol_with_http_info(symbol_id, symbol, callback=callback_function)
        ...
        # verify the required parameter 'symbol_id' is set
        if ('symbol_id' not in params) or (params['symbol_id'] is None):
            raise ValueError("Missing the required parameter `symbol_id` when calling `update_symbol`")
        # verify the required parameter 'symbol' is set
        if ('symbol' not in params) or (params['symbol'] is None):
            raise ValueError("Missing the required parameter `symbol` when calling `update_symbol`")
        ...
        return self.api_client.call_api('/symbol/{symbol_id}', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_symbols_category(self, category_id, category, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_symbols_category(category_id, category, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int category_id: Category id (required)
        :param SymbolCategoryNew category: Category to update (required)
        :return: SymbolCategory
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_symbols_category_with_http_info(category_id, category, **kwargs)
        else:
            (data) = self.update_symbols_category_with_http_info(category_id, category, **kwargs)
            return data

    def update_symbols_category_with_http_info(self, category_id, category, **kwargs):
        """
        Update symbol category
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_symbols_category_with_http_info(category_id, category, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_symbols_category" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'category_id' is set
        if ('category_id' not in params) or (params['category_id'] is None):
            raise ValueError("Missing the required parameter `category_id` when calling `update_symbols_category`")
        # verify the required parameter 'category' is set
        if ('category' not in params) or (params['category'] is None):
            raise ValueError("Missing the required parameter `category` when calling `update_symbols_category`")
        ...
        return self.api_client.call_api('/symbols/category/{category_id}', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
