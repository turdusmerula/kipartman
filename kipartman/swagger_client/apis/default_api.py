...
class DefaultApi(object):
    ...
    def add_unit(self, unit, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_unit(unit, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param UnitNew unit: Unit to add (required)
        :return: Unit
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.add_unit_with_http_info(unit, **kwargs)
        else:
            (data) = self.add_unit_with_http_info(unit, **kwargs)
            return data

    def add_unit_with_http_info(self, unit, **kwargs):
        """
        Creates a new unit
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_unit_with_http_info(unit, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_unit" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'unit' is set
        if ('unit' not in params) or (params['unit'] is None):
            raise ValueError("Missing the required parameter `unit` when calling `add_unit`")
        ...
        return self.api_client.call_api('/units', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_stock(self, stock, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_stock(stock, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param Stock stock: Storage (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_stock_with_http_info(stock, **kwargs)
        else:
            (data) = self.update_stock_with_http_info(stock, **kwargs)
            return data

    def update_stock_with_http_info(self, stock, **kwargs):
        """
        Add an amount of parts to stock
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_stock_with_http_info(stock, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_stock" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'stock' is set
        if ('stock' not in params) or (params['stock'] is None):
            raise ValueError("Missing the required parameter `stock` when calling `update_stock`")
        ...
        return self.api_client.call_api('/stock', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
