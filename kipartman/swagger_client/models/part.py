...
class Part(object):
    ...
    """
    def __init__(self, name=None, description=None, comment=None, octopart=None, updated=None, id=None, category=None, has_childs=None, childs=None, footprint=None, parameters=None, distributors=None, manufacturers=None):
        """
