from dialogs.panel_models_proto import PanelModelsProto
from frames.edit_model_frame_proto import EditModelFrameProto, EVT_EDIT_FOOTPRINT_APPLY_EVENT, EVT_EDIT_FOOTPRINT_CANCEL_EVENT
...
class ModelsFrameProto(PanelModelsProto): 
    def __init__(self, parent):
        super(ModelsFrameProto, self).__init__(parent)
        ...
        self.panel_edit_model = EditModelFrameProto(self.model_splitter)
